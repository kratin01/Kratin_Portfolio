...
const ContactSection = forwardRef((props, ref) => {
  ...
  return (
    ...
    bg-[linear-gradient(110deg,transparent_25%,rgba(255,255,255,0.5)_50%,transparent_75%)]"
            ...
            {/* Focus ring */}
            <span
              className="absolute inset-0 ring-2 ring-red-300/50 rounded-lg 
    opacity-0 group-focus:opacity-100 transition-opacity"
            ></span>
          </button>
        ...
        <div className="flex flex-wrap justify-center gap-12 md:gap-24 mt-8">
          <a
            ...
            className="text-red-300 group relative transition-all duration-300 icon-hover-effect github"
          >
            <FaGithub className="w-16 h-16 relative z-10 transition-all duration-300 ease-in-out group-hover:text-[#181717]" />
          </a>
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="text-red-300 group relative transition-all duration-300 icon-hover-effect linkedin"
          >
            <FaLinkedin className="w-16 h-16 relative z-10 transition-all duration-300 ease-in-out group-hover:text-[#0076b5]" />
          </a>

          <a
            href="https://mail.google.com/mail/?view=cm&fs=1&to=ridlad7@gmail.com"
            className="text-red-300 group relative transition-all duration-300 icon-hover-effect gmail"
            target="_blank"
            rel="noopener noreferrer"
          >
            <SiGmail className="w-16 h-16 relative z-10 transition-all duration-300 ease-in-out group-hover:text-[#db4537e2]" />
          </a>
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="text-red-300 group relative transition-all duration-300 icon-hover-effect whatsapp"
          >
            <FaWhatsapp className="w-16 h-16 relative z-10 transition-all duration-300 ease-in-out group-hover:text-[#25d366]" />
          </a>
        </div>
      </div>
